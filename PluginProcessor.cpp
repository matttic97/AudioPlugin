...
ChainSettings getChainSettings(juce::AudioProcessorValueTreeState& apvts)
{
    ...
    settings.lowCutBypassed = apvts.getRawParameterValue("LowCut Bypassed")->load() > 0.5f;     // rawParameterValue is in [0, 1]
...
juce::AudioProcessorValueTreeState::ParameterLayout AudioPluginAudioProcessor::createParameterLayout()
{
    ...
    layout.add(std::make_unique<juce::AudioParameterBool>("Analyzer Bypassed", "Analyzer Enabled", true));
